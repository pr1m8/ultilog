# ADR: Context at runtime boundaries
...
Request, job, and task context should be bound by middleware, decorators, or context managers rather than by logger creation.
