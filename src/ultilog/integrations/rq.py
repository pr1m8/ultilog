"""rq integration helpers for ultilog.

Purpose
-------
Reserve a stable integration function for rq while the full adapter matures.
...
def install_rq_logging(target: T) -> T:
